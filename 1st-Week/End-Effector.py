...
#  해당 내용은 실제와 상이할수 있습니다. 실제 작업 범위는 링크의 배치, 관절의 제한 등 다양한 요소에 따라 달라질 수 있습니다.
...
def main():
    ...
    print(f"\n 구형 작업 공간 부피 (이론상 최대): {workspace_volume:.2f} m³")
    print(f" 해당 내용은 실제와 상이할수 있습니다. 실제 작업 범위는 링크의 배치, 관절의 제한 등 다양한 요소에 따라 달라질 수 있습니다.")
